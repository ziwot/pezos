...
class GetP2pGossipsubTopicsPeers extends \Pezos\Generated\Dal\Runtime\Client\BaseEndpoint implements \Pezos\Generated\Dal\Runtime\Client\Endpoint
{
    ...
    {
        return '/p2p/gossipsub/topics/peers';
    }
    ...
    /**
     * @return \Pezos\Generated\Dal\Model\P2pGossipsubTopicsPeersGetResponse200Item[]|null
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Pezos\\Generated\\Dal\\Model\\P2pGossipsubTopicsPeersGetResponse200Item[]', 'json');
        }
