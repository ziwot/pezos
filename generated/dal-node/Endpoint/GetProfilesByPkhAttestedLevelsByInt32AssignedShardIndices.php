...
class GetProfilesByPkhAttestedLevelsByInt32AssignedShardIndices extends \Pezos\Generated\Dal\Runtime\Client\BaseEndpoint implements \Pezos\Generated\Dal\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{pkh}', '{int32}'], [$this->pkh, $this->int32], '/profiles/{pkh}/attested_levels/{int32}/assigned_shard_indices');
    }
