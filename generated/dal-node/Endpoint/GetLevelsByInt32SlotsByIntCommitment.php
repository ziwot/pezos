...
class GetLevelsByInt32SlotsByIntCommitment extends \Pezos\Generated\Dal\Runtime\Client\BaseEndpoint implements \Pezos\Generated\Dal\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{int32}', '{int}'], [$this->int32, $this->int], '/levels/{int32}/slots/{int}/commitment');
    }
