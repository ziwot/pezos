...
class PatchP2pPeersByIdByPeerId extends \Pezos\Generated\Dal\Runtime\Client\BaseEndpoint implements \Pezos\Generated\Dal\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $peerId, ?\Pezos\Generated\Dal\Model\P2pPeersByIdPeerIdPatchBody $requestBody = null)
    {
        $this->peer_id = $peerId;
    ...
    {
        if ($this->body instanceof \Pezos\Generated\Dal\Model\P2pPeersByIdPeerIdPatchBody) {
    ...
    /**
     * @return \Pezos\Generated\Dal\Model\P2pPeersByIdPeerIdPatchResponse200|null
     */
