...
class P2pPeersInfoGetResponse200ItemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Pezos\Generated\Dal\Model\P2pPeersInfoGetResponse200ItemInfo::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Pezos\Generated\Dal\Model\P2pPeersInfoGetResponse200ItemInfo::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('conn_metadata', $data)) {
            $object->setConnMetadata($this->denormalizer->denormalize($data['conn_metadata'], \Pezos\Generated\Dal\Model\P2pPeersInfoGetResponse200ItemInfoConnMetadata::class, 'json', $context));
    ...
    {
        return [\Pezos\Generated\Dal\Model\P2pPeersInfoGetResponse200ItemInfo::class => false];
    }
}
