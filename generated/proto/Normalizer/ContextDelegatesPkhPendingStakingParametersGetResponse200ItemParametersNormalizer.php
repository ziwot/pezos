...
class ContextDelegatesPkhPendingStakingParametersGetResponse200ItemParametersNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        $dataArray['limit_of_staking_over_baking_millionth'] = $data->getLimitOfStakingOverBakingMillionth();
        $dataArray['edge_of_baking_over_staking_billionth'] = $data->getEdgeOfBakingOverStakingBillionth();
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
            }
