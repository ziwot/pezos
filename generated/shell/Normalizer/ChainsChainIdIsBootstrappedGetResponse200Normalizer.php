...
class ChainsChainIdIsBootstrappedGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('bootstrapped', $data) && \is_int($data['bootstrapped'])) {
            $data['bootstrapped'] = (bool) $data['bootstrapped'];
        }
    ...
    {
        $dataArray = [];
        $dataArray['bootstrapped'] = $data->getBootstrapped();
        $dataArray['sync_state'] = $data->getSyncState();
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
            }
