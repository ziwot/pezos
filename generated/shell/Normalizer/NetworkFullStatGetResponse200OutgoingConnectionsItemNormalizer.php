...
class NetworkFullStatGetResponse200OutgoingConnectionsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Pezos\Generated\Shell\Model\NetworkFullStatGetResponse200OutgoingConnectionsItem::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Pezos\Generated\Shell\Model\NetworkFullStatGetResponse200OutgoingConnectionsItem::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Pezos\Generated\Shell\Model\NetworkFullStatGetResponse200OutgoingConnectionsItem();
        ...
        if (\array_key_exists('local_metadata', $data)) {
            $object->setLocalMetadata($this->denormalizer->denormalize($data['local_metadata'], \Pezos\Generated\Shell\Model\NetworkFullStatGetResponse200OutgoingConnectionsItemLocalMetadata::class, 'json', $context));
            unset($data['local_metadata']);
        }
        if (\array_key_exists('remote_metadata', $data)) {
            $object->setRemoteMetadata($this->denormalizer->denormalize($data['remote_metadata'], \Pezos\Generated\Shell\Model\NetworkFullStatGetResponse200OutgoingConnectionsItemRemoteMetadata::class, 'json', $context));
    ...
    {
        return [\Pezos\Generated\Shell\Model\NetworkFullStatGetResponse200OutgoingConnectionsItem::class => false];
    }
}
